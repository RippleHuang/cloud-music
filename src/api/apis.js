...
export const albumDetail = (id, s) => post(`/playlist/detail?timestamp=${+new Date()}`, { id, s }) // 获取歌单详情 id-歌单 最近的 s 个收藏者
...
export const getDishInfo = (id) => post(`/album?timestamp=${+new Date()}`, { id }) // 获取专辑内容 参数 专辑id
